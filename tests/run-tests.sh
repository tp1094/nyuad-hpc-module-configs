...
then
    ...
    gencore_app build_man  --environments recipes/r/3.3.1/environment-1.0.yml

    cd /nyuad-conda-configs
    gencore_app build_eb  --environments recipes/r/3.3.1/environment-1.0.yml
    ...
    gencore_app upload_envs  --environments recipes/r/3.3.1/environment-1.0.yml

    scripts/commit_recipes.sh
else
    #Just test packages
    gencore_app build_envs  --environments recipes/r/3.3.1/environment-1.0.yml
